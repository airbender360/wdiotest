...
And Se verifica que el correo electronico no se encuentre registrado
...
And Se verifican los 5 parrafos
And Se verifica la ram "12.00"
#And Se verifica que sea "Amazon's""Choice"
#And Se verifica la marca "Samsung"
